...
<html lang="en">
  <head>
    ...
    <title>IPGS | Manage Students</title>
    <!-- plugins:css -->
...
$sql="SELECT tblstudent.StuID,tblstudent.ID as sid,tblstudent.StudentName,tblstudent.FatherName,tblstudent.ContactNumber,tblclass.ClassName,tblclass.Section from tblstudent join tblclass on tblclass.ID=tblstudent.StudentClass LIMIT $offset, $no_of_records_per_page";
$query = $dbh -> prepare($sql);
$query->execute();
