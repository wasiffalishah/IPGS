...
<html lang="en">
  <head>
    <title>IPGS | Search by Name</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Search Student by Name</h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> Search Student by Name</li>
                </ol>
              </nav>
            </div>
            <div class="row">
                  ...
                  <div class="card-body">
                    <form method="post">
                      <div class="form-group">
                        ...
                        <input id="searchdata" type="text" name="searchdata" required="true" class="form-control" placeholder="Search by Student Name">
                      </div>
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th class="font-weight-bold">Dece</th>
                          </tr>
                        </thead>
                        <tbody>
                          <?php
                          ...
                          if($query->rowCount() > 0) {
                            ...
                            <tr>
                              <td colspan="19"> No record found against this search</td>
                            </tr>
                          <?php } 
                          }?>
                        </tbody>
